...
if not os.path.isfile(train_data_path):
    print("CSV data must be downloaded from https://www.kaggle.com/competitions/social-media-post-approval-prediction-with-marky/data and placed into input_csv directory")
else:
